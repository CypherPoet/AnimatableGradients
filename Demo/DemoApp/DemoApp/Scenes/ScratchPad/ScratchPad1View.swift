...
extension ScratchPad1View: View {
    ...
    var body: some View {
        VStack {
            ...
            RoundedRectangle(cornerRadius: 24)
                .animatableLinearGradient(
                    startColors: [.systemPurple, .systemBlue, .systemOrange, UIColor.white],
                    endColors: [.systemRed, .systemPink, .systemYellow, UIColor.black],
        ...
        .navigationBarTitle(Text("Animatable Linear Gradient"), displayMode: .inline)
    }
}
